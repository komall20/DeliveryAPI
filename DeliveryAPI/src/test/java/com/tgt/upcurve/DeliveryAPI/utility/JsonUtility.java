...
public class JsonUtility {
    ...
    public static DeliveryEntity getDeliveryRequest(String fileName) throws Exception {
        return JsonUtility.readValue(JsonUtility.getResourceAsString(fileName), DeliveryEntity.class);
    }
